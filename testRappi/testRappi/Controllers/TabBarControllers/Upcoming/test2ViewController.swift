...
class test2ViewController: UIViewController {
    ...
    func configure()
    {
        if #available(iOS 10.0, *) {
            self.moviesCollectionView.isPrefetchingEnabled = true
    ...
    {
        //moviesCollectionView.register(UINib(nibName: "CustomCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "cellCon")
    }
    func setUpNavBar()
    {
        UIHelper.setLargeTitles(in: self)
...
extension test2ViewController: UICollectionViewDelegate, UICollectionViewDataSource
{
...
extension test2ViewController: UISearchResultsUpdating, UISearchBarDelegate
{
...
extension test2ViewController: UICollectionViewDataSourcePrefetching{
...
extension test2ViewController: ResponseServicesProtocol
{
